...
public abstract class Heap<T extends Comparable> {
    ...
    public abstract void addItem(T item) throws OutOfHeapBoundException;

    public abstract T popItem() throws OutOfHeapBoundException;
    ...
    public String toString() {
        if (this.count == 0) {
            ...
            return Arrays.toString(Arrays.copyOfRange(this.data, 1, count + 1));
        }
    }
